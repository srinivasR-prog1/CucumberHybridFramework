...
public class Register {
	...
	public void user_enters_the_details_into_below_fields(io.cucumber.datatable.DataTable dataTable) {
		 ...
		 registerPage.enterConfirm(dataMap.get("password"));	 		 
	}
	...
	@Then("account should get proper warning about duplicate email")
	public void account_should_get_proper_warning_about_duplicate_email() {		
		Assert.assertTrue(registerPage.getWarningMessageText().contains("Warning: E-Mail Address is already registered!"));	    
	}

	@When("User not enter any details into fields")
	public void user_not_enter_any_details_into_fields() {
		registerPage = new RegisterPage(driver);
	}
	

	@Then("account should get proper warning messages for every mandatory field")
	public void account_should_get_proper_warning_messages_for_every_mandatory_field() {			
