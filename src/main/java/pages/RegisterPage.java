...
public class RegisterPage {
	...
	{	
		elementUtils.typeTextIntoElement(confirmField, confirmText, CommonUtils.EXPLICIT_WAIT_BASIC_TIME);				
	}
	...
	{
		elementUtils.clickOnElement(selectYesForNewsLetter, CommonUtils.EXPLICIT_WAIT_BASIC_TIME);	
		}
